...
const whatwg_mimetype_1 = require("whatwg-mimetype");
...
class HttpClient {
    ...
    buildRequest(rurl, data, exheaders, exoptions = {}) {
        ...
        const headers = {
            'User-Agent': 'node-soap/' + package_json_1.version,
    ...
    request(rurl, data, callback, exheaders, exoptions) {
        ...
        req.then((res) => {
            ...
            if (_this.options.parseReponseAttachments) {
                ...
                if (isMultipartResp) {
                    let boundary;
                    const parsedContentType = new whatwg_mimetype_1.MIMEType(contentType);
