...
import { IServerOptions, IServerlessRequest, IServerlessResponse, IServices } from './types';
...
export declare class Server extends EventEmitter {
    ...
    processRequest(xml: string, reqOptions?: IServerlessRequest): Promise<IServerlessResponse>;
    private _createServerlessRequest;
    ...
    private _process;
    private _getMethodNameBySoapActionSuffix;
