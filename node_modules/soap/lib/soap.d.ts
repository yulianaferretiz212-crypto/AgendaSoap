...
export declare function listen(server: ServerType | null, path: string | RegExp, services: IServices, wsdl: string, callback?: (err: any, res: any) => void): Server;
export declare function listen(server: ServerType | null, options: IServerOptions): Server;
export declare function createServerless(options: IServerOptions): Promise<Server>;
