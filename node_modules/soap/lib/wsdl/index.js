...
class WSDL {
    constructor(definition, uri, options) {
        ...
        if (typeof definition === 'string') {
            definition = (0, utils_2.stripBom)(definition);
    ...
    xmlToObject(xml, callback) {
        ...
        p.onopentag = (node) => {
            ...
            let name = (0, utils_2.splitQName)(nsName).name;
            let attributeName;
            ...
            for (attributeName in attrs) {
                ...
                if (/^xmlns:|^xmlns$/.test(attributeName)) {
                    const name = (0, utils_2.splitQName)(attributeName).name;
                    xmlns[name] = value;
                    if (value === XSI_URI) {
            ...
            for (attributeName in elementAttributes) {
                const res = (0, utils_2.splitQName)(attributeName);
            ...
            if (xsiType) {
                const type = (0, utils_2.splitQName)(xsiType);
                let typeURI;
                if (type.prefix === utils_2.TNS_PREFIX) {
        ...
        p.onclosetag = (nsName) => {
            ...
            const name = (0, utils_2.splitQName)(nsName).name;
            /**
             * When parsing a string element, we need to correctly transform `<tag></tag>`
             * to an empty string.
             */
            const isStringElement = typeof cur.schema === 'string' && (0, utils_2.splitQName)(cur.schema).name === 'string';
            if (isStringElement) {
            ...
            if ((0, utils_1.isPlainObject)(obj) && !Object.keys(obj).length) {
                obj = null;
            }
            if (topSchema && topSchema[name + '[]']) {
                if (!topObject[name]) {
        ...
        p.ontext = (text) => {
            ...
            const name = (0, utils_2.splitQName)(top.schema).name;
            let value;
    ...
    objectToRpcXML(name, params, nsPrefix, nsURI, isParts) {
        ...
        nsPrefix = nsPrefix || (0, utils_2.findPrefix)(defs.xmlns, nsURI);
        nsURI = nsURI || defs.xmlns[nsPrefix];
        nsPrefix = nsPrefix === utils_2.TNS_PREFIX ? '' : nsPrefix + ':';
        ...
        for (const key in params) {
            ...
            if (key !== nsAttrName) {
                ...
                if (key === this.options.xmlKey) {
                    ...
                    parts.push(typeof value === 'object' ? this.objectToXML(value, key, nsPrefix, nsURI) : (0, utils_2.xmlEscape)(value));
    ...
    objectToXML(obj, name, nsPrefix, nsURI, isFirst, xmlnsAttr, schemaObject, nsContext) {
        ...
        const parts = [];
        const prefixNamespace = (nsPrefix || qualified) && nsPrefix !== utils_2.TNS_PREFIX;
        let xmlnsAttrib = '';
        if (nsURI && isFirst) {
        ...
        if (Array.isArray(obj)) {
            ...
            for (name in obj) {
                ...
                if (name === this.options.valueKey) {
                    nsContext.popContext();
                    return (0, utils_2.xmlEscape)(obj[name]);
                }
                    ...
                    if (this.definitions.schemas) {
                        if (schema) {
                            ...
                            if (childSchemaObject && ((childSchemaObject.$type && childSchemaObject.$type.indexOf('xsd:') === -1) || childSchemaObject.$ref || childSchemaObject.$name)) {
                                ...
                                if (elementQName) {
                                    elementQName = (0, utils_2.splitQName)(elementQName);
                                    childName = elementQName.name;
                                    if (elementQName.prefix === utils_2.TNS_PREFIX) {
                                        // Local element
                                ...
                                if (childSchemaObject.$type) {
                                    const typeQName = (0, utils_2.splitQName)(childSchemaObject.$type);
                                    ...
                                    childNsURI = typeURI;
                                    if (typeURI !== 'http://www.w3.org/2001/XMLSchema' && typePrefix !== utils_2.TNS_PREFIX) {
            ...
            parts.push(this.options.escapeXML ? (0, utils_2.xmlEscape)(obj) : obj);
        }
        nsContext.popContext();
        return parts.join('');
    }
    ...
    findChildSchemaObject(parameterTypeObj, childName, backtrace) {
        ...
        if (object.$ref) {
            ref = (0, utils_2.splitQName)(object.$ref);
        ...
        if (object.$type && backtrace.length === 1) {
            const typeInfo = (0, utils_2.splitQName)(object.$type);
            if (typeInfo.prefix === utils_2.TNS_PREFIX) {
        ...
        if (object.$base && (!Array.isArray(object.children) || !object.children.length)) {
            const baseInfo = (0, utils_2.splitQName)(object.$base);
            childNsURI = parameterTypeObj.$targetNamespace;
            if (baseInfo.prefix !== utils_2.TNS_PREFIX) {
        ...
        if (Array.isArray(object.children) && object.children.length > 0) {
            for (const child of object.children) {
                ...
                if (child.$base) {
                    const baseQName = (0, utils_2.splitQName)(child.$base);
                    const childNameSpace = baseQName.prefix === utils_2.TNS_PREFIX ? '' : baseQName.prefix;
    ...
    _processNextInclude(includes, callback) {
        ...
        open_wsdl_recursive(includePath, options, (err, wsdl) => {
            ...
            if (wsdl.definitions instanceof elements.DefinitionsElement) {
                (0, utils_1.mergeWith)(this.definitions, wsdl.definitions, (a, b) => {
    ...
    _xmlnsMap() {
        ...
        for (const alias in xmlns) {
            if (alias === '' || alias === utils_2.TNS_PREFIX) {
                continue;
            }
